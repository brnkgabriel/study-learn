...
(function ($) {
  ...
  $.fn.magnify = function (options) {
    ...
    var innate = []
    var ken = {}
    var spread, orbit, term, pitch, jug, forge, range, mock, bore, equal, lead;
    var press = 'mousedown touchstart'
    var yaw = 'mousemove.area touchmove.area'
    var ditch = 'mouseup touchend'
    var quash = 'mouseleave touchcancel'
    ...
    function reflectCore() {
      ...
      function baseTrace(task) {
        ...
        var nowX = rub ? rub[0].pageX : task.pageX
        var nowY = rub ? rub[0].pageY : task.pageY
        var sumX = ken.onsetX + nowX - ken.startX
        var sumY = ken.onsetY + nowY - ken.startY
        var altY = ken.travel - ken.unit.top - bore
    ...
    function keepTrack() {
      ...
      var jibe = rise == ken.ante || ken.travel == ken.ere
      var above = ken.travel > ken.unit.top - ken.niche + bore
      var below = ken.travel < ken.unit.top + pitch - bore
      var maiden = ken.travel > ken.dip.top + bore
      var ambit = jug[0].getBoundingClientRect()
    ...
    function heartStash() {
      ...
      ken.zone = (function () {
        ...
        var tree = $('<div>', { id: 'mirror' })
        var ilk = $('<div>', { class: 'coact' })
